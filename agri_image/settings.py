"""
Django settings for agri_image project.
...
LOGIN_REDIRECT_URL = '/'
WSGI_APPLICATION = 'agri_image.wsgi.application'
...
if 'AWS_EN' in os.environ:
    if 'USE_AWS2' in os.environ:
        # Cache control
