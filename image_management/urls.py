...
urlpatterns = [
    ...
    path('image_mangement_edit/<int:ask_id>/', views.image_management_edit, name='image_management_edit'),
    path('image_management_delete/<int:ask_id>/', views.image_management_delete, name='image_management_delete'),
    path('<int:ask_id>/', views.image_management_edit, name='image_management_edit'),
    path('<int:ask_id>/', views.image_management_delete, name='image_management_delete'),
